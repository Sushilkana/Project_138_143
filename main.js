...
function gotPoses(results) {
  ...
  if (results.length > 0) {
    right_wirst_x = results[0].pose.rightWrist.x;
    right_wirst_y = results[0].pose.rightWrist.y;
    console.log("right_wirst_x = " + right_wirst_x + " right_wrist_y = " + right_wirst_y)
...
function draw() {
  ...
  stroke('red')
  fill('red')
  circle(right_wirst_x, right_wirst_y, 10)
